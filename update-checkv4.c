...
static const CatEntry CATALOG[] = {
    ...
    /* Toolchain trio lives under CAT_TOOLCHAIN; remaining 76 here          */
    ...
    /* BLFS */
    /* Python build deps not in LFS base */
    {"pyyaml",           CAT_BLFS}, {"docutils",      CAT_BLFS},
    {"cython",           CAT_BLFS},
    /* Build tools not in LFS base */
...
//    }
    ...
    printf("  Arch:     " RED "%d outdated" NC " | " GREEN "%d current" NC " | " BLUE "%d ahead" NC
           ...
           no, nc_count, na, nn, np - n_track - n_hypr);
